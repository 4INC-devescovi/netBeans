...
public class HashTable3Old {
    ...
    public Integer findElement(PersonaHT element) {        
        ...
        /*if(ELEMENTS[pos] != null && ((LinkedList<Object>)ELEMENTS[pos]).indexOf(element) != -1)
            return pos;
        else
            return -1;*/
        ...
        if(ELEMENTS[pos] != null)
            for(Object elemento: ((LinkedList<Object>)ELEMENTS[pos]))
                if(((PersonaHT)elemento).getNome().equalsIgnoreCase(element.getNome()))
                    trovato = pos;                                
    ...
    public static void main(String[] args) throws Exception {
        HashTable3Old h = new HashTable3Old();
